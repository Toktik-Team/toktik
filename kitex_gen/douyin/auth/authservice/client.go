...
type Client interface {
	Authenticate(ctx context.Context, Req *auth.AuthenticateRequest, callOptions ...callopt.Option) (r *auth.AuthenticateResponse, err error)
...
func (p *kAuthServiceClient) Authenticate(ctx context.Context, Req *auth.AuthenticateRequest, callOptions ...callopt.Option) (r *auth.AuthenticateResponse, err error) {
