...
type ListFeedResponse struct {
	...
	NextTime   *string  `protobuf:"bytes,3,opt,name=next_time,json=nextTime,proto3,oneof" json:"next_time,omitempty"`
...
func (x *ListFeedResponse) GetNextTime() string {
...
var file_feed_proto_rawDesc = []byte{
	...
	0x09, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
